...
export default function CoursesAdminPage() {
  ...
  function load() {
    ...
    setLoading(true);
    api<Paged<Course>>(`/tenant-admin/courses/paged${query}`)
      .then((d) => setData(d))
  ...
  async function createCourse(e: React.FormEvent) {
    e.preventDefault();
    await api("/tenant-admin/courses", { method: "POST", body: form });
    setShowForm(false);
    setForm({
      title: "",
      slug: "",
  ...
  async function removeCourse(id: string) {
    ...
    await api(`/tenant-admin/courses/${id}`, { method: "DELETE" });
    load();
  }
            ...
            {courses.map((c) => (
              <Card key={c.id}>
                ...
                <div className="mt-4 flex gap-2">
                  <a href={`/tenant-admin/courses/${c.id}`}>
